...
void UPlayerRangedAttack::Attack()
{
	...
	//casting vfx
	UNiagaraFunctionLibrary::SpawnSystemAttached(CastingNiagaraSystem, Player->GetDefaultAttachComponent(), FName("SwingSocket"),
		FVector(DistanceInFrontOfPlayerToCastAt, 0.f, 0.f), Player->GetActorRotation(), EAttachLocation::KeepRelativeOffset, true);
