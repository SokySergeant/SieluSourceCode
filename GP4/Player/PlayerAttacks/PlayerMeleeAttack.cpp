...
void UPlayerMeleeAttack::Attack()
{
	...
	UNiagaraFunctionLibrary::SpawnSystemAttached(SwingNiagaraSystem, Player->GetDefaultAttachComponent(), FName("SwingSocket"),
		FVector(SwingDistanceInFrontOfPlayer, 0.f, 0.f), FRotator::ZeroRotator, EAttachLocation::KeepRelativeOffset, true);
	//Forward step
